...
export const createDonation = async (req, res) => {
    ...
    try {
        const [result] = await pool.query(
            'INSERT INTO donations (fundraiser_id, donor_name, donor_email, donor_phone, amount, channel) VALUES (?, ?, ?, ?, ?, ?)',
...
export const updateDonation = async (req, res) => {
    ...
    try {
        const [result] = await pool.query(
            'UPDATE donations SET fundraiser_id = ?, donor_name = ?, donor_email = ?, donor_phone = ?, amount = ? WHERE id = ?',
